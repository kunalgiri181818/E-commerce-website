...
if(isset($_GET['action']) && $_GET['action'] == "delete")
{
	...
	header("location: packet_list.php?product_id=".$_REQUEST['product_id']."&page=".$_REQUEST['page']);
	exit;
}
?>
	...
	<div class="workplace">
		...
		<div class="row-fluid">
			<div class="span12">                    
				...
				<p style="text-align:right;"><button class="btn" type="button" name="back" onclick="window.location.href='add_edit_packet.php?packet_id=<?php echo $fetch_record['packet_id']?>&product_id=<?php echo $_REQUEST['product_id']?>&page=<?php echo $_REQUEST['page'];?>'">Add Packet</button></p>
