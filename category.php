    			...
    			<section class="inner-header parallax" style="background-image: url('images/bg/category.jpg');">
      				<div class="container">
						<div class="section-content">
							<div class="row">
								<div class="col-md-12">
									<h2 class="title text-white text-center" style="text-align:center;">Product Category</h2>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="item">
										<div class="mb-30">
											...
											<div class="thumb" style="border:1px solid #DEDEDE;">
												<img class="img-fullwidth" alt="" src="uploads/category/<?php echo $arr_category['category_photo'];?>">
											</div></a>
											<div class="pt-5 pb-5" style="text-align:center; background-color:#DEDEDE;">
												<h4 class="" style="color:#333333;">
												<?php if($num_subcat>0) { ?>
												<a href="subcategory.php?category_id=<?php echo $arr_category['category_id'];?>" style="color:#333333;">
												<?php } else { ?>
												<a href="product-list.php?category_id=<?php echo $arr_category['category_id'];?>" style="color:#333333;">
												<?php } ?>
