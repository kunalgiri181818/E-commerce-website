...
$sqlEdit = "UPDATE `og_orders` SET `transaction_completed` = 'Yes' WHERE `user_id` = '".$_SESSION['USER_ID']."' AND `unique_id` = '".$session_id."'";
    			...
    			<section class="inner-header parallax" style="background-image: url('images/bg/category.jpg');">
      				<div class="container">
						<div class="section-content">
							<div class="row">
								<div class="col-md-12">
									<h2 class="title text-white text-center" style="text-align:center;">Order Successful</h2>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="section-content">
							<div class="row mt-10">
								<div class="col-sm-12 col-md-12 mb-sm-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
									<p style="text-align:center;">Thanks for your order. Our representative will contact you to confirm your address for delivery your product(s). Our payment system is Cash on Delivery(COD).</p>
									<?php //if($o_date>'15:00') { ?>
									<!--<p style="text-align:center; font-weight:bold;">Your product will deliver tomorrow before 3:00 PM.</p>-->
									<?php //} else { ?>
									<!--<p style="text-align:center; font-weight:bold;">Your product will deliver today after 3:00 PM.</p>-->
									<?php //} ?>
								</div>
							</div>
						</div>
