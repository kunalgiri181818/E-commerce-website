...
//http://www.morningbazar.co.in/webservice/service.php?action=organic_benefits
...
//http://www.morningbazar.co.in/webservice/service.php?action=about_us
function _about_us() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=notification
...
//http://www.morningbazar.co.in/webservice/service.php?action=terms
function _terms() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=order_cancellation
...
//http://www.morningbazar.co.in/webservice/service.php?action=return_refund
...
//http://www.morningbazar.co.in/webservice/service.php?action=privacy
function _privacy() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=refer_earn
...
//http://www.morningbazar.co.in/webservice/service.php?action=delivery_text
...
//http://www.morningbazar.co.in/webservice/service.php?action=why_choose
...
//http://www.morningbazar.co.in/webservice/service.php?action=our_contacts
...
//http://www.morningbazar.co.in/webservice/service.php?action=login&phone=8240138798&password=123456&device_token_id=123
function _login() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=registration&fname=Saptarshi&lname=Ghosh &email=saptarshi.mailme@gmail.com&phone=9007272180&password=123456&confirm_password=123456
...
//http://www.morningbazar.co.in/vehcl/webservice/service.php?action=otp_validation&otp=1111&user_id=1&unique_id=1234567890
...
//http://www.morningbazar.co.in/webservice/service.php?action=forgot_password&phone=9007272180
...
//http://www.morningbazar.co.in/webservice/service.php?action=my_account&user_id=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=change_password&old_password=123456&new_password=1111111&confirm_password=1111111&user_id=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=edit_profile&fname=Saptarshi&lname=Ghosh &email=saptarshi.mailme@gmail.com&phone=9007272180&address=abc&city=Kolkata&state=West Bengal&zip=700085
...
//http://www.morningbazar.co.in/webservice/service.php?action=category
function _category() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=subcategory&category_id=3
...
//http://www.morningbazar.co.in/webservice/service.php?action=product_list&category_id=3&subcategory_id=3&user_id=1&unique_id=11111111111&brand_id=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=most_selling_product_list&user_id=1&unique_id=11111111111
...
//http://www.morningbazar.co.in/webservice/service.php?action=add_to_cart&user_id=1&unique_id=11111111111&product_id=1&packet_id=1&quantity=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=view_cart&user_id=1&unique_id=11111111111
function _view_cart() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=delete_item&cart_id=1&$user_id=1&unique_id=11111111111
...
//http://www.morningbazar.co.in/webservice/service.php?action=update_item&cart_id=1&$user_id=1&unique_id=11111111111&quantity=1&isCartAdd=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=zipcode_list
...
//http://www.morningbazar.co.in/webservice/service.php?action=zipcode_availability&zip=700085
...
//http://www.morningbazar.co.in/webservice/service.php?action=checkout&fname=Saptarshi&lname=Ghosh&email=saptarshi.mailme@gmail.com&phone=8240138798&address=9, Chandi Bose Lane, Kolkata - 700085&city=Kolkata&state=West Bengal&zip=700085&user_id=1&unique_id=11111111111&pickup_date=2020-02-20&pickup_time=7am-9am
function _checkout() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=order_thankyou&user_id=1&unique_id=11111111111&payment_type=Online&transaction_id=123456&payment_status=Success
function _order_thankyou() 
{
	...
	{
	    $sqlEdit = "UPDATE `og_orders` SET `transaction_completed` = 'Yes' WHERE `unique_id` = '".$unique_id."'";
    	$exeEdit = mysql_query($sqlEdit) or die(mysql_error());
	...
	$data['Ack'] = 1;
	$data['msg'] = 'Thanks for your order. Our representative will contact you to confirm your address for delivery your product(s). Your payment system is Cash on Delivery(COD).';

    echo json_encode($data);
    return json_encode($data);
}

//http://www.morningbazar.co.in/webservice/service.php?action=post_enquiry&user_id=1&name=Rajib Majumdar&email=rajibmaj2001@gmail.com&phone=8240138798&comment=Only for test
...
//http://www.morningbazar.co.in/webservice/service.php?action=search_result&user_id=1&unique_id=11111111111&search_string=potato
...
//http://www.morningbazar.co.in/webservice/service.php?action=banners
function _banners() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=my_orders&user_id=1
function _my_orders() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=order_details&user_id=1&order_id=12qwaszx123
...
//http://www.morningbazar.co.in/webservice/service.php?action=cancel_order_request&user_id=1&order_id=123&request_comment=111
...
//http://www.morningbazar.co.in/webservice/service.php?action=offers
function _offers() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=post_suggestion&user_id=1&comment=Only for test&order_id=BM510
...
//http://www.morningbazar.co.in/webservice/service.php?action=view_suggestion&user_id=1&order_id=BM510
...
//http://www.morningbazar.co.in/webservice/service.php?action=my_referral&user_id=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=pickup_time&pickup_date=2020-05-18
...
//http://www.morningbazar.co.in/webservice/service.php?action=sliding_product_list&user_id=1&unique_id=11111111111
...
//http://www.sayanivegetables.com/webservice/service.php?action=registration_resend_otp&unique_id=123456&user_id=1
...
//http://www.morningbazar.co.in/webservice/service.php?action=resend_otp&unique_id=123456&phone=364334634
...
//http://www.morningbazar.co.in/webservice/service.php?action=whychoose
function _whychoose() 
{
    $data = array();
...
//http://www.morningbazar.co.in/webservice/service.php?action=home_delivery_slot
